        ...
        <div className="container mx-auto px-6">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-700 mt-4 text-base lg:text-lg max-w-3xl mx-auto">
              ...
              whose ultimate sacrifice fueled our mission for justice and peace
              for Palestinians.
            </p>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center bg-white shadow-2xl rounded-3xl overflow-hidden">
            ...
            <div className="p-6 md:p-8 flex flex-col justify-center md:w-2/3 text-center md:text-left">
              ...
              <p className="text-gray-700 leading-relaxed mb-4 text-sm lg:text-base">
                ...
                with unwavering courage. On May 20th, 2024, at 3:00 AM, during a
                peaceful protest at D-Chowk, Islamabad, he, along with another
                protestor, was murdered in cold blood when a car ruthlessly and
                intentionally ran over the protesters. His life was taken while
                he was peacefully standing for the rights of Gaza. His sacrifice
                has become a beacon of hope, a symbol of unwavering dedication,
