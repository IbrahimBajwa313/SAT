...
const ServicesData = [
  ...
  {
    img: "/samplePic.jpg",
    name: "SAT OnGround Activities",
    heading: "Supporting Gaza with Essential Services",
    text: "SAT OnGround Activities in Gaza provide essential services to support the community. Our Food Camps, Cloth Drive, and Medical Camps ensure nourishment, warmth, and health. Join us in making a positive impact and bringing relief to Gaza.",
    url: "groundActivities",
  },
  {
    img: "/samplePic.jpg",
    name: "SAT Monthly Subscription",
    heading: "Support Gaza with a Monthly Contribution",
    text: "Join the SAT Monthly Subscription program to provide continuous support to the people of Gaza. Your monthly contributions will help fund essential services and relief efforts, ensuring sustained aid and support for those in need.",
    url: "subscription",
  },
  {
    img: "/samplePic.jpg",
    name: "SAT Virtual Adoption",
    heading: "Virtually Adopt a Child in Gaza",
    text: "Through SAT Virtual Adoption, you can provide for a child's nexeds in Gaza. Your support will cover essentials such as food, clothing, and education, making a significant impact on their life and future.",
    url: "virtualAdoption",
  },
];
